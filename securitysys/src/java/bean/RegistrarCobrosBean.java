 ...
 *
 */
@ManagedBean(name = "RegistrarCobrosBean")
@ViewScoped
@Data
public class RegistrarCobrosBean implements Serializable {
    ...
    public String guardarReclamo() {
        ...
        reclamo.setIdDepartamento(departamentoFacade.findByIdDepartamento(idDepartamento));
        ...
        reclamo.setIdTipoReclamo(tiporeclamoFacade.findByIdTipoReclamo(idTipoReclamo));
