 ...
 */
@Embeddable
public class OrdenCompraCabPK implements Serializable {
    ...
    public OrdenCompraCabPK() {
    }

    public OrdenCompraCabPK(String tipoOrdenCompra, String serOrdenCompra, BigInteger nroOrdenCompra) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OrdenCompraCabPK)) {
            return false;
        }
        OrdenCompraCabPK other = (OrdenCompraCabPK) object;
    ...
    public String toString() {
        return "entities.OrdenCompraCabPK[ tipoOrdenCompra=" + tipoOrdenCompra + ", serOrdenCompra=" + serOrdenCompra + ", nroOrdenCompra=" + nroOrdenCompra + " ]";
    }
