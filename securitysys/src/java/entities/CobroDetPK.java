 ...
 */
@Embeddable
public class CobroDetPK implements Serializable {
    ...
    public CobroDetPK(int idCobro, int idCtaACobrar, int idVenta) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CobroDetPK)) {
            return false;
        }
        CobroDetPK other = (CobroDetPK) object;
    ...
    public String toString() {
        return "entities.CobroDetPK[ idCobro=" + idCobro + ", idCtaACobrar=" + idCtaACobrar + ", idVenta=" + idVenta + " ]";
    }
